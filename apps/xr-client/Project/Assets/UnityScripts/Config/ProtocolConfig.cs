...
namespace ARAIPet.Config
{
    ...
    public static class ProtocolConfig
    {
        ...
        // ── 消息类型：Stack-chan 移动（Part 8）──
        public const string TypePetMove             = "pet.move";           // 发移动指令
        public const string TypePetMoveStop         = "pet.move.stop";      // 紧急停止
        public const string TypePetMoveHome         = "pet.move.home";      // 回家
        public const string TypePetMoveArrived      = "pet.move.arrived";   // b 回报：到达了
        public const string TypePetPoseReport       = "pet.pose.report";    // b 回报：实时位置
        public const string TypePetMoveFailed       = "pet.move.failed";    // b 回报：移动失败
