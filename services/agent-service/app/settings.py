...
DATA_SERVICE_WS_URL = os.getenv("DATA_SERVICE_WS_URL", "ws://localhost:8080/ws/data")
...
AGENT_TOOL_MODE = os.getenv("AGENT_TOOL_MODE", "external")
ROBOT_DISPATCH_MODE = os.getenv("ROBOT_DISPATCH_MODE", "none")
ROBOT_ADAPTER = os.getenv("ROBOT_ADAPTER", "mock")
ROBOT_DEVICE_ID = os.getenv("ROBOT_DEVICE_ID", "mock-robot")
STACKCHAN_WS_URL = os.getenv("STACKCHAN_WS_URL", "ws://127.0.0.1:8080/ws")
STACKCHAN_TOKEN = os.getenv("STACKCHAN_TOKEN", "")
STACKCHAN_MAX_SPEED = int(os.getenv("STACKCHAN_MAX_SPEED", "180"))
STACKCHAN_MAX_DURATION_SECONDS = float(os.getenv("STACKCHAN_MAX_DURATION_SECONDS", "1.5"))
DEVICE_ACTION_TIMEOUT_SECONDS = float(os.getenv("DEVICE_ACTION_TIMEOUT_SECONDS", "0.8"))
