...
生成时间：`2026-08-09T08:04:56.412226+00:00`
...
- 固件 SHA256：`7a7a1e7216e1a7b664d1c264f37c50b53a63b4546bd4546b96ef81b364caa268`
...
| `CONFIG_STACKCHAN_TOUCH_PTT` | `1` | `None` |
| `CONFIG_USE_AFE_WAKE_WORD` | `1` | `None` |
| `CONFIG_USE_CUSTOM_WAKE_WORD` | `None` | `None` |
| `CONFIG_SR_WN_WN9_NIHAOXIAOZHI_TTS` | `1` | `None` |
| `CONFIG_SR_MN_CN_NONE` | `1` | `None` |
| `CONFIG_SR_MN_CN_MULTINET6_QUANT` | `None` | `None` |
| `CONFIG_USE_AUDIO_PROCESSOR` | `1` | `None` |
