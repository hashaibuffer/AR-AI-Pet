...
生成时间：`2026-08-09T10:28:52.554126+00:00`
...
- 固件 SHA256：`48cf6bfbb6c067a1fd9e2dd8e9c70e98dbfeefb06cd52254a19733db74eb05dc`
...
```json
{
  ...
  "build_log_evidence": [
    "Note: Found multinet models ['mn6_cn', 'fst'] but USE_CUSTOM_WAKE_WORD is disabled, skipping",
