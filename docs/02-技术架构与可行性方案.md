...
| StackChan | 实体表达、触摸和基础本地响应 | 已确认，接口待实机确认 |
...
| Agent | [QwenPaw](https://github.com/agentscope-ai/QwenPaw)限时验证，[AgentScope](https://github.com/agentscope-ai/agentscope)作为备选 | 二选一，不并行维护 |
